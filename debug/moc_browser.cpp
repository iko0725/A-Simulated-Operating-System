...
#include "../CSC3002project/browser.h"
...
QT_MOC_LITERAL(4, 28, 24), // "on_pushButton_gp_clicked"
QT_MOC_LITERAL(5, 53, 18) // "showThread_browser"

    },
    "Browser\0sendData\0\0sendData2\0"
    "on_pushButton_gp_clicked\0showThread_browser"
};
...
void Browser::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->on_pushButton_gp_clicked(); break;
        case 3: _t->showThread_browser(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Browser::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Browser::sendData)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Browser::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Browser::sendData2)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void Browser::sendData(QString _t1)
{
...
// SIGNAL 1
void Browser::sendData2(QString _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
