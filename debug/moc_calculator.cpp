...
#include "../CSC3002project/calculator.h"
...
QT_MOC_LITERAL(4, 31, 21) // "showThread_calculator"

    },
    "Calculator\0sendData\0\0sendData2\0"
    "showThread_calculator"
};
...
void Calculator::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->showThread_calculator(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Calculator::sendData)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Calculator::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Calculator::sendData2)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void Calculator::sendData(QString _t1)
{
...
// SIGNAL 1
void Calculator::sendData2(QString _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
