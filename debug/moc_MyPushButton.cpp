...
#include "../CSC3002project/MyPushButton.h"
...
QT_MOC_LITERAL(1, 13, 10), // "sigTimeout"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 11), // "sig_showWgt"
QT_MOC_LITERAL(4, 37, 11) // "sig_hideWgt"

    },
    "MyPushButton\0sigTimeout\0\0sig_showWgt\0"
    "sig_hideWgt"
};
...
void MyPushButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sigTimeout(); break;
        case 1: _t->sig_showWgt((*reinterpret_cast< QPoint(*)>(_a[1]))); break;
        case 2: _t->sig_hideWgt(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyPushButton::sigTimeout)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (MyPushButton::*)(QPoint );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyPushButton::sig_showWgt)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (MyPushButton::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyPushButton::sig_hideWgt)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 0
void MyPushButton::sigTimeout()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void MyPushButton::sig_showWgt(QPoint _t1)
{
